...
const [{ default: express }, { default: cookieParser }, { default: morgan }, { corsMiddleware, errorHandler, sessionMiddleware }, { registerRoutes }, { getAgentName }, { config }] = await Promise.all([
  import("express"),
...
app.listen(PORT, () => {
  ...
  console.log(`📡 AI Project: ${process.env.AI_PROJECT_ENDPOINT}`);
