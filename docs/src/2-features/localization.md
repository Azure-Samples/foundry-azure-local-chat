...
| `chat.inputPlaceholder` | `"Message Copilot"` |
| `chat.inputAriaLabel` | `"Edge Core AI Chat"` |
...
2. Update `getText.ts` to support language selection:
...
getText('greeting', 'John', 'Edge Core AI')
// → "Hello John, welcome to Edge Core AI!"
```
