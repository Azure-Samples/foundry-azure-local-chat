...
| [Azure Deployment](server/docs/azure-deployment.md) | Deploy to Azure App Service |
...
[Setup Guide](server/README.md) | [Azure Deployment](server/docs/azure-deployment.md)
