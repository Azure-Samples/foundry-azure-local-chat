...
export const ChatSubItem = ({ conversation, onDelete, onRename }: ChatSubItemProps) => {
  ...
  const [renameValue, setRenameValue] = React.useState(conversation.metadata.title || "");
  ...
  const handleRenameClick = () => {
    setMenuOpen(false);
    setRenameValue(conversation.metadata.title || "");
    setIsRenaming(true);
  ...
  const handleRenameSubmit = () => {
    if (renameValue.trim() && renameValue !== conversation.metadata.title && onRename) {
        ...
        {(triggerProps: MenuButtonProps) => (
          <SplitCopilotNavItem
            navItem={{
              ...
              children: (
                <span className={styles.conversationTitle} title={conversation.metadata.title}>
            ...
            menuButton={{ ...triggerProps, "aria-label": `More options, ${conversation.metadata.title}` }}
            menuButtonTooltip={{
